...
function gmetric ( ganglia_host, ganglia_port, ganglia_spoof = null ) {
...
gmetric.protocol.append_xdr_string = function ( buf, s ) {
...
gmetric.prototype.writevalue = function ( buf, host, name, type, val, spoof = null) {
...
gmetric.prototype.writemeta = function ( buf, host, name, type, units, slope, tmax, dmax, spoof = null ) {
